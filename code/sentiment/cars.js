    ...
    // Read dummy data
    d3.json("https://raw.githubusercontent.com/anly503/spring2023-project-team-14/text_data/data/bigrams_cars.json?token=GHSAT0AAAAAACAHA2V5EYT3VSJTMZK7OTT4ZCAXTLQ", function( data) {
      ...
      nodes
        .on('mouseover', function (d) {
          ...
          labels
            .style("font-size", function(label_d){ return label_d.name === d.name ? 14 : 6 } )
