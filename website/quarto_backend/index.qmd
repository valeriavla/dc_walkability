...
<div id="myDiv">
  ...
  background: linear-gradient(to right, rgba(148, 46, 46, 0.784) 0%, rgba(148, 46, 46, 0.784) 50%, rgba(148, 46, 46, 0.784) 100%);
  color: #fff;
...
<div id="cars">bi-grams relation of reddit threads about cars in D.C.<br></div>
<!-- Cars script -->
